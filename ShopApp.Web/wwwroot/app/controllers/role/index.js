    ...
    function registerEvents() {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        shopApp.notify('Update role successful', 'success');
                    ...
                    error: function () {
                        shopApp.notify('Has an error', 'error');
                        shopApp.stopLoading();
                    }
                });
                return false;
        ...
        $('body').on('click', '.btn-delete', function (e) {
            ...
            shopApp.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    error: function (status) {
                        shopApp.notify('Has an error in deleting progress', 'error');
                        shopApp.stopLoading();
                    }
                });
            });
        ...
        $("#btnSavePermission").off('click').on('click', function () {
            ...
            $.ajax({
                ...
                success: function (response) {
                    shopApp.notify('Save permission successful', 'success');
                    $('#modal-grantpermission').modal('hide');
                    shopApp.stopLoading();
                },
                error: function () {
                    shopApp.notify('Has an error in save permission progress', 'error');
                    shopApp.stopLoading();
                }
            });
        });
