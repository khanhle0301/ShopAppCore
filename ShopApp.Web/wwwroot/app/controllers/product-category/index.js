        ...
        $('body').on('click', '#btnDelete', function (e) {
            ...
            shopApp.confirm('Are you sure to delete?', function () {
                $.ajax({
                    ...
                    success: function (response) {
                        shopApp.notify('Deleted success', 'success');
                        shopApp.stopLoading();
                        loadData();
                    },
                    error: function (status) {
        ...
        $('#btnSave').on('click', function (e) {
            if ($('#frmMaintainance').valid()) {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        shopApp.notify('Update success', 'success');
                    ...
                    error: function () {
                        shopApp.notify('Has an error in update progress', 'error');
                        shopApp.stopLoading();
                    }
                });
            }
    ...
    function loadData() {
        $.ajax({
            ...
            success: function (response) {
                ...
                var treeArr = shopApp.unflattern(data);
